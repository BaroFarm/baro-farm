...
// AI 설명 생성
router.get('/:productId/description/ai-gen', (req, res) => {
  res.sendFile(path.join(__dirname, '../views/ai-gen.html')); // ai-gen.html은 직접 만들어야 함
});
...
// AI 설명 저장
router.get('/:productId/description/summary', (req, res) => {
  res.sendFile(path.join(__dirname, '../views/summary.html'));
});

router.post('/:productId/description/ai-save', async (req, res) => {
  const productId = req.params.productId;
