...
export default function QuickPickUp({
  ...
  onChangeDelivery,
  onQuantityChange,
  onDeleteSingle,          // ✅ 부모에서 내려주는 삭제 핸들러 사용
  selectedFarm,
  ...
  return (
    <div style={{ textAlign: 'left' }}>
        ...
        {cartItems.map((item) => (
          <li key={item.cart_item_id}>
            <CartItem
              ...
              onDelete={() => onDeleteSingle(item.cart_item_id)}  
      ...
      <p>
        바로찾음 서비스는 날짜와 시간, 상품을 구매할 매장을 지정한 후 직접 픽업할 수 있는 서비스입니다.
      </p>
          ...
          <form>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                />
                <button type="button" onClick={() => setIsDeliveryModalOpen(true)}>
                  주소 찾기
                </button>
              </div>
            </div>
